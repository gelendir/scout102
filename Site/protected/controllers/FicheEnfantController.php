...
class FicheEnfantController extends Controller
{
    ...
    public function genererScout() {
        ...
        $adulte = Adulte::model()->findByPk(
            Yii::app()->user->id
        );

        $RecuImpot->NOM_PERSONNE = $adulte->NOM;
        $RecuImpot->PRENOM_PERSONNE = $adulte->PRENOM;
        $RecuImpot->COURRIEL_D_ENVOIE = $adulte->COURRIEL;

        $Scout->CONT_URG_NOM = $adulte->NOM;
        $Scout->CONT_URG_PRENOM = $adulte->PRENOM;
        $Scout->CONT_URG_NO_TEL = $adulte->NO_TEL_PRINCIPAL;
    ...
    public function actionUpdate( $id )
    {
        ...
        if( isset( $_POST['Scout'] ) && isset( $_POST['RecuImpot'] ) ) {
            ...
            $scout->attributes = $_POST['Scout'];
            $scout->recuImpot->attributes = $_POST['RecuImpot'];
